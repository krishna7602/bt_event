...
export const defaultSiteConfig = {
  ...
  about: {
    conferenceHtml:
      `<p>The <strong>DBT-CTEP and ANRF-sponsored National Conference on “Recent Innovations in Circular Economy for Waste Valorisation and Environmental Sustainability” (RICE-WVES)</strong> is a major event scheduled to be held at NIT Jalandhar, India, bringing together researchers, academicians, industry professionals, and innovators to exchange ideas and advancements in the environmental sustainability domain. The conference aims to foster interdisciplinary dialogue and collaboration in the evolving fields of waste valorization, circular economy, biological waste treatment, wastewater treatment and resource recovery. The conference will include plenary talks, technical paper and poster presentations, and interactive sessions. It will provide an enriching experience for young researchers, faculty, and students by offering insights into various aspects of environmental sustainability aligned with the Sustainable Development Goals (SDGs). The organizing committee welcomes original research contributions that address real-world challenges and innovative solutions in the given thematic and allied areas.</p>`,
    objectives: [
