    ...
    <section id="registration" className="py-16 bg-white">
      <div className="w-full px-4 md:px-8 lg:px-12">
        <div className="rounded-3xl overflow-hidden shadow-xl">
          <div className="bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-6">
              ...
              <table className="w-full border-collapse bg-white rounded-lg">
                ...
                <tbody>
                  {dates.map((item, index) => (
                    <tr
                      key={item.event}
                      className={`border-b border-gray-100 transition-colors ${item.highlight ? "bg-red-50 hover:bg-red-100" : index % 2 === 0 ? "bg-gray-50 hover:bg-blue-50" : "bg-white hover:bg-blue-50"}`}
                    >
