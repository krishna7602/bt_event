              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-mono text-xl font-bold text-rose-400 underline decoration-rose-500/30 underline-offset-8 animate-blink inline-block">9 May, 2026</span>
                  </div>
                </div>
              </div>
